...
function VPA.CreateMainFrame()
    ...
    frame.Text:SetSize(420, 80)
    frame.Text:SetPoint("TOPLEFT", 70, -40)
    frame.Text:SetJustifyH("LEFT")
    frame.Text:SetJustifyV("TOP")
    frame.Text:SetText("What are you looking for? Shift-click an item or start typing.")
    frame.Text:SetTextColor(1, 1, 1, 0.5)
